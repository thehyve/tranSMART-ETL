...
create or replace synonym tm_cz.DE_RBM_DATA_ANNOTATION_JOIN for DEAPP.DE_RBM_DATA_ANNOTATION_JOIN ;
grant select, insert, update, delete on  DEAPP.DE_RBM_DATA_ANNOTATION_JOIN to tm_cz;
